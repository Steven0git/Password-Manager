      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <h2 data-aos="fade-down">Welcome to <span>Password Manager</span></h2>
            <p data-aos="fade-up">Password Manager, your digital guardian in the realm of cyberspace, expertly safeguards and organizes your passwords with unparalleled precision. </p>
          <div class="d-flex justify-content-center">
            <a data-aos="fade-up" data-aos-delay="200" href="/signup" class="btn-get-started row">Sign Up</a>
            <a data-aos="fade-up" data-aos-delay="200" href="/login" class="btn-get-started row">Sign In</a>
          </div>
          </div>
        </div>
      </div>
